...
function compileInstance(instance: any, id: string) {
    ...
    return compile(instance.render(), {...instance}, methodMap, instance._name, id)
}

function compile(template: string, variables: Record<string, string>, methods: Record<string, string>, componentName?: string, id?: string) {
    ...
    }).replace(/<(\w+)/, defineComponent(variables, componentName, id))
}
...
function defineComponent(variables: Record<string, string>, componentName = 'root', id?: string) {
